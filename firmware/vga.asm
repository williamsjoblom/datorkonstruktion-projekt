...
;;; 
;;; Write string pointed to by A(lsb) and Y(msb) with color X
;;; 
vga_put_str:
	STA $40
	STY $41
...
;;; Write 8 bit hex number in A
vga_put_hex:
	PHA
	LSR #4
	JSR vga_put_hex_digit
	PLA
	AND #$0F
	JSR vga_put_hex_digit
	RTS
	
;;; Write hex digit in A
vga_put_hex_digit:
	LDY #$F0		; Set color to black/white
	
	CMP #10
	BPL vga_put_hex_digit_alpha
	;; Write 0-9
	ADC #$30
	JSR vga_put_char
	RTS
vga_put_hex_digit_alpha:
	;; Write A-F
	ADC #$37
	JSR vga_put_char
	RTS
